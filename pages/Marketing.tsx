    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow space-y-4">
            ...
            <div>
                ...
                <select id="platform" value={platform} onChange={e => setPlatform(e.target.value)} className="mt-1 block w-full rounded-md border border-brand-gray-600 bg-brand-gray-800 px-3 py-2 text-white shadow-sm placeholder:text-brand-gray-400 focus:border-brand-cyan-500 focus:ring-1 focus:ring-brand-cyan-500 sm:text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                    ...
                    <select
                        ...
                        className="mt-1 block w-full rounded-md border border-brand-gray-600 bg-brand-gray-800 px-3 py-2 text-white shadow-sm placeholder:text-brand-gray-400 focus:border-brand-cyan-500 focus:ring-1 focus:ring-brand-cyan-500 sm:text-sm"
                    >
