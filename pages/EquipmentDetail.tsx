    ...
    return (
        <form onSubmit={handleSubmit} className="p-4 bg-brand-gray-50 rounded-lg border border-brand-gray-200 mt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <input type="date" value={date} onChange={e => setDate(e.target.value)} required className="block w-full rounded-md border border-brand-gray-600 bg-brand-gray-800 px-3 py-2 text-white shadow-sm placeholder:text-brand-gray-400 focus:border-brand-cyan-500 focus:ring-1 focus:ring-brand-cyan-500 sm:text-sm" />
                <input type="text" placeholder="Service description" value={description} onChange={e => setDescription(e.target.value)} required className="md:col-span-2 block w-full rounded-md border border-brand-gray-600 bg-brand-gray-800 px-3 py-2 text-white shadow-sm placeholder:text-brand-gray-400 focus:border-brand-cyan-500 focus:ring-1 focus:ring-brand-cyan-500 sm:text-sm" />
                <input type="number" placeholder="Cost" value={cost} onChange={e => setCost(parseFloat(e.target.value) || 0)} className="block w-full rounded-md border border-brand-gray-600 bg-brand-gray-800 px-3 py-2 text-white shadow-sm placeholder:text-brand-gray-400 focus:border-brand-cyan-500 focus:ring-1 focus:ring-brand-cyan-500 sm:text-sm" />
