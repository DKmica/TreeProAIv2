                ...
                <div className="border-t border-brand-gray-200 p-4 bg-white rounded-b-lg">
                    <form onSubmit={handleSubmit} className="flex items-center space-x-2">
                        <input
                            ...
                            className="flex-1 block w-full px-3 py-2 rounded-md border border-brand-gray-300 bg-white text-gray-900 shadow-sm placeholder:text-brand-gray-400 focus:border-brand-green-500 focus:ring-brand-green-500 sm:text-sm"
