      ...
      <div className="p-4 border-t border-brand-gray-200 mt-4">
        <form onSubmit={handleSubmit} className="flex items-center space-x-3">
          <input
            ...
            className="flex-1 block w-full px-3 py-2 rounded-md border border-brand-gray-600 bg-brand-gray-800 text-white shadow-sm placeholder:text-brand-gray-400 focus:border-brand-cyan-500 focus:ring-1 focus:ring-brand-cyan-500 sm:text-sm"
